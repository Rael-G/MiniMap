...
public class MapperOptions
{
    ...
    /// </summary>
    public Dictionary<string, string> CustomMappings { get; private set; } = [];

    /// <summary>
    /// Stores the names of source properties that should be ignored during mapping.
    /// </summary>
    public HashSet<string> IgnoredProperties { get; private set; } = [];
    ...
    /// </summary>
    public Dictionary<string, Func<object?, object?>> CustomTransformations { get; private set; } = [];
